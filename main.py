...
START = f"""
**๏ ʜᴇʏ, ɪ ᴀᴍ [{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}]({START_IMG1})**
**➻ ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ**
**──────────────**
...
DEV_OP = [
    ...
    [
        InlineKeyboardButton(
            text="🧸 ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ 🧸",
            url=f"https://t.me/{Miss_Sona_Bot}?startgroup=true",
        ),
    ],
    [
...
HELP_READ = f"""
<u>**ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ {➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}**</u>
<u>**ᴀʀᴇ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ!**</u>
...
TOOLS_DATA_READ = f"""
<u>**ᴛᴏᴏʟs ғᴏʀ {➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥} ᴀʀᴇ:**</u>
**➻ ᴜsᴇ `/repo` ғᴏʀ ɢᴇᴛᴛɪɴɢ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ!**
**──────────────**
**➻ ᴜsᴇ `/ping` ғᴏʀ ᴄʜᴇᴄᴋɪɴɢ ᴛʜᴇ ᴘɪɴɢ ᴏғ {➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}**
**──────────────**
<b>||©️ @{ii_Romana_ii}||</b>
"""
...
HELP_BUTN = [
     [
           InlineKeyboardButton(text="🚀 ʜᴇʟᴘ 🚀", url=f"https://t.me/{Miss_Sona_Bot}?start=help"),
           InlineKeyboardButton(text="🐳 ᴄʟᴏsᴇ 🐳", callback_data="CLOSE"),
     ],
]
...
SOURCE_READ = f"**ʜᴇʏ, ᴛʜᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ᴏғ [{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}](https://t.me/{Miss_Sona_Bot}) ɪs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.**\n**ᴘʟᴇᴀsᴇ ғᴏʀᴋ ᴛʜᴇ ʀᴇᴘᴏ & ɢɪᴠᴇ ᴛʜᴇ sᴛᴀʀ ✯**\n**──────────────────**\n**ʜᴇʀᴇ ɪs ᴛʜᴇ [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://t.me/TheLove2Forever**/n**──────────────────**\n**ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{TheLove2Forever}).\n<b>||©️ @{ii_Romana_ii}||</b>"

ABOUT_READ = f"""
**➻ [{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}](https://t.me/{Miss_Sona_Bot}) ɪs ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛ-ʙᴏᴛ.**
**➻ [{BOT_NAME}](https://t.me/{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}) ʀᴇᴘʟɪᴇs ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴛᴏ ᴀ ᴜsᴇʀ.**
...
**──────────────**
**➻ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ғᴏʀ ɢᴇᴛᴛɪɴɢ ʙᴀsɪᴄ ʜᴇʟᴩ ᴀɴᴅ ɪɴғᴏ ᴀʙᴏᴜᴛ [{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}](https://t.me/{Miss_Sona_Bot})**
"""
@bot.on_message(filters.command(["start", "aistart", f"start@{Miss_Sona_Bot}"]))
async def restart(client, m: Message):
    if m.chat.type == "private":
        ...
        await m.reply_photo(
            ...
            caption=f"""**๏ ʜᴇʏ, ɪ ᴀᴍ [{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}](t.me/{Miss_Sona_Bot})**\n**➻ ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ.**\n**──────────────**\n**➻ ᴜsᴀɢᴇ /chatbot [ᴏɴ/ᴏғғ]**\n<b>||๏ ʜɪᴛ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ғᴏʀ ʜᴇʟᴘ||</b>""",
...
@bot.on_message(filters.command(["help", f"help@{Miss_Sona_Bot}"], prefixes=["+", ".", "/", "-", "?", "$"]))
async def restart(client, m: Message):
    if m.chat.type == "private":
...
async def get_st(_, msg: Message):
    ...
    await msg.reply_photo(photo="https://te.legra.ph/file/370114a8d01cbc3f432ef.jpg",
                          caption=f"""ᴛᴏᴛᴀʟ sᴛᴀᴛs ᴏғ {➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}
          ➻ **ᴄʜᴀᴛs :** {chats}
          ➻ **ᴜsᴇʀs :** {users}"""
    )
...
async def ping(client, message: Message):
    ...
    await message.reply_photo(
        photo=random.choice(PHOTO),
        caption=f"нey вαву!!\n**[{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥}](t.me/{Miss_Sona_Bot})** ιѕ alιve 🥀 αnd worĸιng ғιne wιтн a pιng oғ\n➥ `{ms}` ms\n\n<b>||мαdє ωιтн ❣️ ву [Developer](https://t.me/{ii_Romana_ii})||</b>",
        reply_markup=InlineKeyboardMarkup(PNG_BTN),
    )

                  
@bot.on_message(
    filters.command(["chatbot", f"chatbot@{Miss_Sona_Bot}"])
    & ~filters.private)
...
print(f"{➤⃝ ⃝⃪⃕🥀ꗄ╬𝗠𝗶𝘀𝘀𝆺꯭𝅥ꗝؖؖؖؖ𝆺꯭𝅥𝗦𝗼𝗻𝗮─⃛͢•𝆺꯭𝅥༎𓆪🌿─̶̶⃛͢⃝❤️‍🔥} ɪs ᴀʟɪᴠᴇ! ɴᴏᴡ ғᴜᴄᴋ ᴏғғ! ᴀɴᴅ ɢᴏ ᴛᴏ @TheLove2Forever ʙɪᴛᴄʜ!!")      
bot.run()
